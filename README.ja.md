...
このESモジュールは日本の郵便番号を住所に変換します。(地方公共団体コードと町名)

GitHub Actions [scheduled-fetch.yml](https://github.com/code4fukui/PostalCode/blob/master/.github/workflows/scheduled-update.yml)によって、毎日更新をチェックしています。
